...
echo "starting streamer on $1 (/var/scratch/ddps2105/Python-3.9.7/python streamer.py --host $1.cm.cluster --p-purchase 1 --p-ad 0 --generators 24)"
/var/scratch/ddps2105/Python-3.9.7/python streamer.py --host $1.cm.cluster --p-purchase 1 --p-ad 0 --generators 24